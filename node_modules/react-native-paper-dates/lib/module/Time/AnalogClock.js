...
function AnalogClock({
  ...
  const theme = useTheme(); // used to make pointer shorter if hours are selected and above 12
  ...
  const onPointerMove = React.useCallback((e, final) => {
    ...
    if (focusedRef.current === clockTypes.hours) {
      ...
      let hours12AndPm = !hours24 && previousHourType === hourTypes.pm; // TODO: check which mode is switched on am/pm
