...
exports.default = exports.monthHeaderSingleHeight = exports.monthHeaderSingleMarginBottom = exports.monthHeaderSingleMarginTop = exports.montHeaderHeight = exports.weekSize = exports.weekMargin = void 0;
...
function Month(props) {
  ...
  const validRangeStart = (validRange === null || validRange === void 0 ? void 0 : validRange.startDate) instanceof Date ? (0, _dateUtils.dateToUnix)(new Date(validRange === null || validRange === void 0 ? void 0 : validRange.startDate.getFullYear(), validRange === null || validRange === void 0 ? void 0 : validRange.startDate.getMonth(), validRange === null || validRange === void 0 ? void 0 : validRange.startDate.getDate(), 0, 0, 0)) : undefined;
  const validRangeEnd = (validRange === null || validRange === void 0 ? void 0 : validRange.endDate) instanceof Date ? (0, _dateUtils.dateToUnix)(new Date(validRange === null || validRange === void 0 ? void 0 : validRange.endDate.getFullYear(), validRange === null || validRange === void 0 ? void 0 : validRange.endDate.getMonth(), validRange === null || validRange === void 0 ? void 0 : validRange.endDate.getDate(), 23, 59, 59)) : undefined;
  const {
    monthName,
    month,
    year
    ...
    return monthGrid(index).map(({
      ...
      return {
        ...
        generatedDays: days.map((_, dayIndex) => {
          ...
          const isWithinOptionalValidRange = (0, _dateUtils.isDateWithinOptionalRange)(day, {
  ...
  }, [year, month, index, startDate, endDate, date, dates, validRangeStart, validRangeEnd, mode]);
