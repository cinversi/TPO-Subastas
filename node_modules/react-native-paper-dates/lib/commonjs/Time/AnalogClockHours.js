...
function AnalogClockHours({
  ...
  const outerRange = getHourNumbers(false, _timeUtils.circleSize, 12);
  const innerRange = getHourNumbers(true, _timeUtils.circleSize, 12);
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, outerRange.map((a, i) => /*#__PURE__*/React.createElement(_reactNative.View, {
    ...
    selectable: false
  }, i + 1)))), is24Hour ? innerRange.map((a, i) => /*#__PURE__*/React.createElement(_reactNative.View, {
    key: i,
    pointerEvents: "none",
