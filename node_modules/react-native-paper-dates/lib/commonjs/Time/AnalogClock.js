...
function AnalogClock({
  ...
  const theme = (0, _reactNativePaper.useTheme)(); // used to make pointer shorter if hours are selected and above 12
  ...
  const onPointerMove = React.useCallback((e, final) => {
    ...
    if (focusedRef.current === _timeUtils.clockTypes.hours) {
      ...
      let hours12AndPm = !hours24 && previousHourType === _timeUtils.hourTypes.pm; // TODO: check which mode is switched on am/pm
